-- Fixed RPC function with proper type casting to avoid type mismatch errors
...
BEGIN
    ...
    SELECT DISTINCT
        c.id as court_id,
        c.name::TEXT as court_name,    -- Explicitly cast to TEXT
        c.type::TEXT as court_type,    -- Explicitly cast to TEXT
        c.jurisdiction::TEXT,          -- Explicitly cast to TEXT
        c.judge_count,
...
-- SELECT * FROM get_top_courts_by_cases('CA', 3);