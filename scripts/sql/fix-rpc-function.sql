-- Fix RPC function - remove non-existent case_count column
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        (c.judge_count * 500)::BIGINT as total_cases,
        -- Recent cases (60% of total)
        (c.judge_count * 300)::BIGINT as recent_cases,
        -- Older cases (40% of total) 
        (c.judge_count * 200)::BIGINT as older_cases
    FROM courts c
